...
const Bio = () => {
  return (
    <section className=" flex justify-between text-[#2A3E04] max-w-full items-center lg:pr-24 text-center lg:text-start ">
      <div className=" flex flex-col gap-[44px]">
        <p className=" text-4xl font-semibold">Hi, I’m Ayodeji</p>
        <p className=" text-4xl font-bold">- a Front-End Engineer.</p>
        <p className=" text-xl font-semibold">
          Who loves creating smooth and easy-to-use user interfaces. <br /> With
          strong skills in React, I build digital experiences that are simple,
          functional, and creatively unique. <br /> I focus on understanding
          what users need and turning those ideas into clean, effective, and
          reliable code.
        </p>
      </div>
